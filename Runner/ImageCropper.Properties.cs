...
namespace Controls
{
    ...
    public partial class ImageCropper
    {
        ...
        public static readonly DependencyProperty ImageRotationProperty = DependencyProperty.Register(
            "ImageRotation", typeof(double), typeof(ImageCropper), new PropertyMetadata(default(double)));
        ...
        public double ImageRotation
        {
            ...
            set
            {
                ...
                //_restrictedCropRect.Width = (Source.PixelHeight + 80) * ScaledImageValue;
                //_restrictedCropRect.Height = (Source.PixelHeight + 80) * ScaledImageValue;
                //_restrictedCropRect.X = -((Source.PixelHeight + 150) * ScaledImageValue / 4);
                //_currentCroppedRect.Width = Source.PixelHeight;
                //_currentCroppedRect.Height = Source.PixelHeight;
                //_currentCroppedRect.X = _restrictedCropRect.X;
        ...
        public static readonly DependencyProperty ScaledImageValueProperty = DependencyProperty.Register(
            "ScaledImageValue", typeof(double), typeof(ImageCropper), new PropertyMetadata(default(double)));

        public double ScaledImageValue
        {
            get { return (double)GetValue(ScaledImageValueProperty); }
            set
            {
                SetValue(ScaledImageValueProperty, value);

                _restrictedCropRect.Width = Source.PixelWidth * ScaledImageValue;
                _restrictedCropRect.Height = ScaledImageValue * Source.PixelHeight;

                ImageCenterX = _restrictedCropRect.Width / 2;
        ...
        public static readonly DependencyProperty ImageCenterXProperty = DependencyProperty.Register(
            "ImageCenterX", typeof(double), typeof(ImageCropper), new PropertyMetadata(default(double)));

        public double ImageCenterX
        {
            get { return (double)GetValue(ImageCenterXProperty); }
            set { SetValue(ImageCenterXProperty, value); }
        }

        public static readonly DependencyProperty ImageCenterYProperty = DependencyProperty.Register(
            "ImageCenterY", typeof(double), typeof(ImageCropper), new PropertyMetadata(default(double)));

        public double ImageCenterY
        {
            get { return (double)GetValue(ImageCenterYProperty); }
            set { SetValue(ImageCenterYProperty, value); }
        }
