...
namespace Controls
{
    ...
    public partial class ImageCropper : Control
    {
        ...
        internal Rect _currentCroppedRect = Rect.Empty;
        internal Rect _restrictedCropRect = Rect.Empty;
        internal Rect _restrictedSelectRect = Rect.Empty;
        ...
        protected override void OnApplyTemplate()
        {
            ...
            _imageGrid = GetTemplateChild(ImageGrid) as Grid;
